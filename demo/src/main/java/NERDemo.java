...
public class NERDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String serializedClassifier = "/home/joseph/smartdev/bitbucket/webwordsV2/demo/src/main/resources/stanford_classifiers/english.all.3class.distsim.crf.ser.gz";
    ...
    */
      ...
      */
            ...
            String fileContents = IOUtils.slurpFile("/home/joseph/smartdev/bitbucket/webwordsV2/demo/src/main/resources/data/test.txt");
            ...
            System.out.println("---");
            /*out = classifier.classifyFile("/home/joseph/smartdev/bitbucket/webwordsV2/demo/src/main/resources/data/test.txt");
            for (List<CoreLabel> sentence : out) {
                for (CoreLabel word : sentence) {
                    System.out.print(word.word() + '/' + word.get(CoreAnnotations.AnswerAnnotation.class) + ' ');
                }
...
//            classifier.classifyAndWriteAnswersKBest("/home/joseph/smartdev/bitbucket/webwordsV2/demo/src/main/resources/data/test.txt", 10, readerAndWriter);

            System.out.println("---");
            System.out.println("Per-token marginalized probabilities");
            classifier.printProbs("/home/joseph/smartdev/bitbucket/webwordsV2/demo/src/main/resources/data/test.txt", readerAndWriter);
      ...
      */
            ...
            /*for (String str : example) {
                System.out.print(classifier.classifyToString(str, "inlineXML", false));
            }*/
            System.out.println("---");
